...
/**
 * A namespace for defining the theme's Icon component.
 * @theme 0.1.0
 */
export namespace Icon {
    ...
    /**
     * An enum representing the available icon types.
    ...
    export namespace Variations {
        ...
        // * ===========================================================================
        // * Icon Variations - Size
        // * ===========================================================================

        export enum Size {
            /**
             * A variation for the Icon component that sets the size to custom.
             * @theme 0.1.0
             */
            Custom = "icon--size-custom",
            /**
             * A variation for the Icon component that sets the size to small.
             * @theme 0.1.0
             */
            Small = "icon--size-small",
            /**
             * A variation for the Icon component that sets the size to medium.
             * @theme 0.1.0
             */
            Medium = "icon--size-medium",
            /**
             * A variation for the Icon component that sets the size to large.
             * @theme 0.1.0
             */
            Large = "icon--size-large",
            /**
             * A variation for the Icon component that sets the size to extra large.
             * @theme 0.1.0
             */
    ...
    /**
     * A type representing the properties of the Icon component.
     * @theme 0.1.0
     */
    export type Properties = JSX.IntrinsicElements["i"] & {
        ...
        properties: {
            /**
             * An object representing the data of the Icon component.
             * @theme 0.1.0
             */
            type: Icon.Type,
            /**
             * An object representing the variations of the Icon component.
             * @theme 0.1.0
             */
            variations?: {
                /**
                 * The size variation of the Icon component.
                 * @theme 0.1.0
                 */
                size?: Variations.Size,
                /**
                 * The variant of the Icon component.
                 * @theme 0.1.0
                 */
    ...
    /**
     * A type guard for the Icon component.
     * @param obj - The object to check.
     * @returns true if the object is an Icon component, false otherwise.
     * @theme 0.1.0
     */
    export const is = (obj: any) : obj is Icon.Properties => {
        if ((obj as Icon.Properties).properties.type) {
            return true;
        }
        return false;
    };
    ...
    /**
     * A type guard for the Icon component's icon type.
     * @param type - The icon type to check.
     * @returns true if the icon type is valid, false otherwise.
     * @example
     * ```typescript
     * if (Icon.isIconType("add")) {
     *    console.log("The icon type is valid.");
     * }
     * ```
     * @theme 0.1.0
     */
    export const isType = (type: any) : type is Icon.Type => {
        return (Object.values(Icon.Type).indexOf(type) !== -1);
    };

    /**
     * A type guard for the Icon component's variant type.
     * @param variant - The variant type to check.
     * @returns true if the variant type is valid, false otherwise.
     * @example
     * ```typescript
     * if (Icon.isVariant("primary")) {
     *   console.log("The variant type is valid.");
     * }
     * ```
     * @theme 0.1.0
     */
    export const isVariant = (variant: any) : variant is Variations.Variant => {
        return (Object.values(Variations.Variant).indexOf(variant) !== -1);
    }

    /**
     * A type guard for the Icon component's size type.
     * @param size - The size type to check.
     * @returns true if the size type is valid, false otherwise.
     * @example
     * ```typescript
     * if (Icon.isSize("small")) {
     *   console.log("The size type is valid.");
     * }
     * ```
     * @theme 0.1.0
     */
    export const isSize = (size: any) : size is Variations.Size => {
        return (Object.values(Variations.Size).indexOf(size) !== -1);
    }
    ...
    /**
     * A functional component for the Icon component.
     * @param properties - The properties of the Icon component.
     * @param className - The class name of the Icon component.
     * @param rest - The rest of the properties of the Icon component.
     * @returns The Icon component.
     * @theme 0.1.0
     */
    export const Atom : FunctionComponent<Properties> = ({ properties, className, ...rest } : Properties) : JSX.Element => {
        const generateClassName = () => {
            ...
            const classes = {
                component_props: className !== undefined
                ? className.split(" ")
                : [],
                data: {
                    type: properties.type,
                    variations: {
                        size: properties.variations?.size !== undefined
                            ? properties.variations.size
                            : Variations.Size.Small,
                        variant: properties.variations?.variant !== undefined
                            ? properties.variations.variant
                            : Variations.Variant.Default,
                    }
                },
            };
            classesArray.push(classes.data.type);
            classesArray.push(classes.data.variations.size);
            classesArray.push(classes.data.variations.variant);
            return [... new Set(classesArray)].join(" ");
        };
        return (
            <i
                aria-label={ `${properties.type} icon` }
